...
!(function(t, e) {
        ...
        return (
            ...
            function(t, e, r) {
                ...
                if (!c) {
                    ...
                    for (c = y[d] = [], i = b ? Math.min(f, d) * w - 0.5 : g % f, n = b ? (d * x) / f - 0.5 : (g / f) | 0, l = X, u = h = 0; u < d; u++)
    ...
    function Za(u, t) {
        var h,
            l,
            e = H(u);
        return (!e && s(u) && ((h = e = u.radius || X), u.values ? ((u = xt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = Ya(u.increment))),
            Na(
                t,
                e ?
                p(u) ?
        ...
        if (!c) {
            if ((',' === t.substr(-1) && (t = t.substr(0, t.length - 1)), Mt[t])) c = Mt[t];
                ...
                if (((c = d = t.match(tt)), e)) {
                    ...
                    (s = (+c[0] % 360) / 360), (o = c[1] / 100), (i = 2 * (u = c[2] / 100) - (n = u <= 0.5 ? u * (o + 1) : u + o - u * o)), 3 < c.length && (c[3] *= 1), (c[0] = pb(s + 1 / 3, i, n)), (c[1] = pb(s, i, n)), (c[2] = pb(s - 1 / 3, i, n));
        ...
        bt = function _parsePosition(t, e, r) {
            ...
            return o(e) && (isNaN(e) || e in s) ?
                ((n = e.charAt(0)),
                    ...
                    i < 0 ?
                    (e in s || (s[e] = h), s[e]) :
                    ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))), a && r && (n = (n / 100) * (H(r) ? r[0] : r).totalDuration()), 1 < i ? _parsePosition(t, e.substr(0, i - 1), r) + n : h + n)) :
                null == e ?
                h :
                +e;
        },
                ...
                return arguments.length ?
                    (this._ps !== t &&
                        ((this._ps = t) ?
                            ...
                            (Dt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== U && (this._tTime -= U)))),
                        this) :
                    this._ps;
            }),
    ...
    var qt = (function(n) {
        ...
        return (
                ...
                if (v !== this._tTime || r || y) {
                    if ((_ !== this._time && g && ((v += this._time - _), (t += this._time - _)), (i = v), (f = this._start), (u = !(l = this._ts)), y && (g || (_ = this._zTime), (!t && e) || (this._zTime = t)), this._repeat)) {
                        ...
                        if (
                            ((i = ca(v % o)),
                                ...
                                (d = gt(this._tTime, o)), !_ && this._tTime && d !== s && (d = s),
                                c && 1 & s && ((i = g - i), (p = 1)),
                                s !== d && !this._lock)
                        ) {
                            var b = c && 1 & d,
                            ...
                            if (
                                (s < d && (b = !b),
                                    ...
                                    (this._tTime = v), !e && this.parent && Pt(this, 'onRepeat'),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            (this._time = i),
                            (this._act = !l),
                            this._initted || ((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = t), (_ = 0)), !_ && i && !e && (Pt(this, 'onStart'), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
                    ...
                    this._onUpdate && !e && Pt(this, 'onUpdate', !0),
                        ...
                        ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                            ...
                            ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ra(this, 1),
                                e || (t < 0 && !_) || (!v && !_ && m) || (Pt(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
                }
                return this;
            }),
            ...
            (e.totalTime = function totalTime(t, e) {
                return arguments.length ?
                    ((this._forcing = 1), !this._dp && this._ts && (this._start = ca(St.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))), n.prototype.totalTime.call(this, t, e), (this._forcing = 0), this) :
                    this._tTime;
            }),
    ...
    var Yt,
                    ...
                    (f || e in t || N(e, i),
                        function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                            var o,
                                ...
                                m = 0,
                                g = 0;
                            for (_.b = r, _.e = i, r += '', (c = ~(i += '').indexOf('random(')) && (i = fb(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || [];
                                (o = it.exec(i));)
                                (l = o[0]),
        ...
        Ut = function _initTween(e, r) {
            ...
            if (
                (!B || (M && v) || (v = 'none'),
                    ...
                    (e._from = !B && !!g.runBackwards), !B)
            ) {
                if (((p = (l = D[0] ? _(D[0]).harness : 0) && g[l.prop]), (i = ma(g, ut)), S && S.render(-1, !0).kill(), y))
                    if (
                        (ra((e._startAt = Qt.set(D, ia({ data: 'isStart', overwrite: !1, parent: z, immediateRender: !0, lazy: t(T), startAt: null, delay: 0, onUpdate: w, onUpdateParams: x, callbackScope: O, stagger: 0 }, y)))),
                    ...
                    (r && (b = !1), (a = ia({ overwrite: !1, data: 'isFromStart', lazy: b && t(T), immediateRender: b, stagger: 0, parent: z }, i)), p && (a[l.prop] = p), ra((e._startAt = Qt.set(D, a))), r < 0 && e._startAt.render(-1, !0), b)
                ) {
                    if (!r) return;
        ...
        Qt = (function(C) {
            function Tween(e, r, i, n) {
                    ...
                    if (((r = a.vars), (o = a.timeline = new qt({ data: 'nested', defaults: x || {} })).kill(), (o.parent = o._dp = _assertThisInitialized(a)), (o._start = 0), w))
                        ...
                        for (u = 0; u < l; u++) {
                            ...
                            k && (h.yoyoEase = k),
                                ...
                                (h.delay = (+Vt(g, _assertThisInitialized(a), u, d, A) || 0) - a._delay), !b && 1 === l && h.delay && ((a._delay = g = h.delay), (a._start += g), (h.delay = 0)),
                                o.to(d, h, c(u, d, A));
                        }
                ...
                return (!0 !== T || F || ((Yt = _assertThisInitialized(a)), R.killTweensOf(A), (Yt = 0)),
                    ...
                    if (p) {
                        if (_ !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
                            if (((i = _), (l = this.timeline), this._repeat)) {
                                ...
                                if (
                                    ((i = ca(_ % s)),
                                        _ === c ? ((a = this._repeat), (i = p)) : ((a = ~~(_ / s)) && a === _ / s && ((i = p), a--), p < i && (i = p)),
                            ...
                            this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, r), Pt(this, 'onUpdate')),
                                ...
                                (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0),
                                    ...
                                    e || (t < 0 && !d) || (!_ && !d) || (Pt(this, _ === c ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (_ < c && 0 < this.timeScale()) || this._prom()));
                        }
                    } else
                        !(function _renderZeroDurationTween(t, e, r, i) {
                            var n,
                                ...
                                l = 0;
                            if (
                                (h && t._repeat && ((l = Tt(0, t._tDur, e)), (a = gt(l, h)), (s = gt(t._tTime, h)), t._yoyo && 1 & a && (u = 1 - u), a !== s && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
    ...
    ba(
            _t + 'parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger',
            function(t) {
                return (ut[t] = 1);
            }
        ),
    ...
    function Ad(t, e, r, i) {
        ...
        return (
            ...
            Ie[e] && 'transform' !== e ?
            ((n = $e(t, i)), (n = 'transformOrigin' !== e ? n[e] : n.svg ? n.origin : Je(od(t, Xe)) + ' ' + n.zOrigin + 'px')) :
            ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) || (n = (Qe[e] && Qe[e](t, e, r)) || od(t, e) || aa(t, e) || ('opacity' === e ? 1 : 0)),
        ...
        if (((v.b = r), (v.e = i), (r += ''), 'auto' === (i += '') && ((t.style[e] = i), (i = od(t, e) || i), (t.style[e] = r)), vb((s = [r, i])), (i = s[1]), (u = (r = s[0]).match(rt) || []), (i.match(rt) || []).length)) {
            for (;
                ...
                ((h = parseFloat(f) || 0),
                    ...
                    m !== _ && (h = zd(t, e, f, _) || 0),
                    (v._pt = { _next: v._pt, p: p || 1 === b ? p : ',', s: h, c: g ? g * c : c - h, m: (l && l < 4) || 'zIndex' === e ? Math.round : 0 }));
    ...
    function Ld(t, e, r, i, n, a) {
        ...
        r
            ...
            ((w = (s = ud(t)).x + (~T[0].indexOf('%') ? (w / 100) * s.width : w)), (x = s.y + (~(T[1] || T[0]).indexOf('%') ? (x / 100) * s.height : x))),
    ...
    function Xd(t, e, r) {
        var i,
            ...
            l = Wd({}, r._gsap),
            f = r.style;
        for (n in (l.svg ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[Ye] = e), (i = $e(r, 1)), wd(r, Ye), r.setAttribute('transform', a)) : ((a = getComputedStyle(r)[Ye]), (f[Ye] = e), (i = $e(r, 1)), (f[Ye] = a)),
                Ie))
            (a = l[n]) !== (s = i[n]) &&
            'perspective,force3D,transformOrigin,svgOrigin'.indexOf(n) < 0 &&
            ((o = Pa(a) !== (h = Pa(s)) ? zd(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new ae(t._pt, i, n, o, u - o, $c)), (t._pt.u = h || 0), t._props.push(n));
        Wd(i, l);
    }
    var ue,
        he,
            ...
            return (
                ...
                ((b = m[0]),
                    ...
                    ((E = m[6]),
                        ...
                        (a = m[14]),
                        (h = (g = Fe(E, D)) * Ee),
                        g && ((k = O * (v = Math.cos(-g)) + C * (y = Math.sin(-g))), (M = P * v + S * y), (A = E * v + D * y), (C = O * -y + C * v), (S = P * -y + S * v), (D = E * -y + D * v), (I = z * -y + I * v), (O = k), (P = M), (E = A)),
                        (l = (g = Fe(-w, D)) * Ee),
                        g && ((v = Math.cos(-g)), (I = x * (y = Math.sin(-g)) + I * v), (b = k = b * v - C * y), (T = M = T * v - S * y), (w = A = w * v - D * y)),
                        (u = (g = Fe(T, b)) * Ee),
                        g && ((k = b * (v = Math.cos(g)) + T * (y = Math.sin(g))), (M = O * v + P * y), (T = T * v - b * y), (P = P * v - O * y), (b = k), (O = M)),
                        ...
                        (c = I ? 1 / (I < 0 ? -I : I) : 0)),
                    r.svg && ((k = t.getAttribute('transform')), (r.forceCSS = t.setAttribute('transform', '') || !Id(od(t, Ye))), k && t.setAttribute('transform', k))),
        ...
        ir = function _renderSVGTransforms(t, e) {
            ...
            d || c ?
                ((d *= Be),
                    ...
                    (n = Math.sin(d - c) * -m),
                    (a = Math.cos(d - c) * m),
                    c && ((p *= Be), (s = Math.tan(c - p)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), p && ((s = Math.tan(p)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
                    (r = ca(r)),
                    (i = ca(i)),
                    (n = ca(n)),
                    (a = ca(a))) :
        ...
        or = {
            ...
            init: function init(t, e, r, i, n) {
                ...
                for (f in (fe || rd(), e))
                    ...
                    if (
                        (w && f in w ? ((a = 'function' == typeof w[f] ? w[f].call(r, i, t, n) : w[f]), f in Y.units && !Pa(a) && (a += Y.units[f]), '=' === (a + '').charAt(1) && (a = Ad(t, f))) : (a = Ad(t, f)),
                            (u = parseFloat(a)),
                            (p = 'string' === h && '=' === s.charAt(1) ? +(s.charAt(0) + '1') : 0) && (s = s.substr(2)),
                            (o = parseFloat(s)),
                            f in qe &&
                            ('autoAlpha' === f && (1 === u && 'hidden' === Ad(t, 'visibility') && o && (u = 0), xd(this, T, 'visibility', u ? 'inherit' : 'hidden', o ? 'inherit' : 'hidden', !o)),
                                'scale' !== f && 'transform' !== f && ~(f = qe[f]).indexOf(',') && (f = f.split(',')[0])),
                            (_ = f in Ie))
                    )
                        if (
                            (m || (((g = t._gsap).renderTransform && !e.parseTransform) || $e(t, e.parseTransform), (v = !1 !== e.smoothOrigin && g.smooth), ((m = this._pt = new ae(this._pt, T, Ye, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)),
                                'scale' === f)
                        )
                            (this._pt = new ae(this._pt, g, 'scaleY', g.scaleY, (p ? p * o : o - g.scaleY) || 0)), b.push('scaleY', f), (f += 'X');
                        else {
