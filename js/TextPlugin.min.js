...
!(function(D, u) {
    ...
    function splitInnerHTML(D, u, F) {
        for (var C = D.firstChild, E = []; C;)
            3 === C.nodeType ? E.push.apply(E, emojiSafeSplit((C.nodeValue + '').replace(/^\n+/g, '').replace(/\s+/g, ' '), u, F)) : 'br' === (C.nodeName + '').toLowerCase() ? (E[E.length - 1] += '<br>') : E.push(C.outerHTML),
            (C = C.nextSibling);
        return E;
    }
    ...
    function emojiSafeSplit(D, u, F) {
        ...
        for (var C, E, e = [], t = D.length, n = 0; n < t; n++)
            ((55296 <= (E = D.charAt(n)).charCodeAt(0) && E.charCodeAt(0) <= 56319) || (65024 <= D.charCodeAt(n + 1) && D.charCodeAt(n + 1) <= 65039)) &&
            ((C = ((D.substr(n, 12).split(i) || [])[1] || '').length || 2), (E = D.substr(n, C)), (n += C - (e.emoji = 1))),
            e.push('>' === E ? '&gt;' : '<' === E ? '&lt;' : E);
        return e;
    }
    var u,
        ...
        F = {
            ...
            init: function init(D, u, F) {
                ...
                if (((s.target = D), 'object' != typeof u && (u = { value: u }), 'value' in u)) {
                    for (
                        ...
                        C.push(s.fillChar);
                    if ('diff' === u.type) {
                        for (n = [], B = [], i = '', r = t = 0; r < E.length; r++)(A = E[r]) === e[r] ? (i += A) : ((n[t] = i + A), (B[t++] = i + e[r]), (i = ''));
                        (E = n), (e = B), i && (E.push(i), e.push(i));
                    }
                    u.speed && F.duration(Math.min((0.05 / u.speed) * C.length, u.maxDuration || 9999)), (this.original = e), (this.text = E), this._props.push('text');
            ...
            render: function render(D, u) {
                ...
                var F,
                    ...
                    o = (D * l + 0.5) | 0;
                (E = t ?
                    ((C = B && o !== l), ((F = n && o) ? "<span class='" + n + "'>" : '') + e.slice(0, o).join(i) + (F ? '</span>' : '') + (C ? "<span class='" + B + "'>" : '') + i + s.slice(o).join(i) + (C ? '</span>' : '')) :
                    e.slice(0, o).join(i) + i + s.slice(o).join(i)),
                u.svg ? (A.textContent = E) : (A.innerHTML = '&nbsp;' === r && ~E.indexOf('  ') ? E.split('  ').join('&nbsp;&nbsp;') : E);
            },
        };
